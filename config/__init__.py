...
_SYSTEM_MAPPING = {
    ...
    'exchanges.primary_exchange': 'PRIMARY_EXCHANGE',
    'exchanges.primary_fallback': 'PRIMARY_EXCHANGE_FALLBACK',
    'exchanges.price_divergence_max_pct': 'PRICE_DIVERGENCE_MAX_PCT',
