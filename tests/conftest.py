...
def mock_config(monkeypatch):
    ...
    monkeypatch.setattr(config, 'RISK_MAX_POSITION_PCT', 0.5)
    monkeypatch.setattr(config, 'SHORT_STRATEGY_POOL_PCT', 60)
    monkeypatch.setattr(config, 'FUNDING_ARB_POOL_PCT', 20)
    monkeypatch.setattr(config, 'LOW_RISK_POOL_PCT', 20)
